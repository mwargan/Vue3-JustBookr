...
export enum eventTypes {
  ...
  changed_university = "changed_university",
  posted_offer = "posted_offer",
  subscribed_to_post_notifications = "subscribed_to_post_notifications",
  unsubscribed_from_post_notifications = "unsubscribed_from_post_notifications",
}
